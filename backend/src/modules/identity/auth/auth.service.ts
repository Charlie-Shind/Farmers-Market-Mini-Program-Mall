    ...
    return this.buildSessionResponse(
      {
        ...
        avatarUrl: this.platformDataService.toPublicUrl(resolveProfileText(user.avatarUrl, '')),
    ...
    return this.buildSessionResponse(
      {
        ...
        avatarUrl: this.platformDataService.toPublicUrl(resolveProfileText(guestUser.avatarUrl, '')),
