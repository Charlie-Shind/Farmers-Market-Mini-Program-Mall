Page({
  data: {
  "slug": "marketing-publish",
  "title": "发布活动",
  "subtitle": "配置活动类型、商品、时间和规则",
  "mode": "marketingForm",
  "showBack": true,
  "hasBottom": false,
  "pageClass": "no-bottom",
  ...
  "categories": [
    {
      "title": "限时秒杀",
      "desc": "价格、库存、限购",
      "icon": "/assets/illustrations/activity.svg",
      "active": true
    },
    {
      "title": "拼团活动",
      "desc": "人数、团时、团价",
      "icon": "/assets/illustrations/store.svg",
      "active": false
    },
    {
      "title": "满减优惠券",
      "desc": "门槛、金额、库存",
      "icon": "/assets/illustrations/finance.svg",
      "active": false
    },
    {
      "title": "预售活动",
      "desc": "定金、尾款、发货",
      "icon": "/assets/illustrations/delivery.svg",
      "active": false
    }
  ],
  "skuList": [],
